    ...
    <div class="girl_list">
        ...
        <form id="boxes" name="girl_list_form" action="" method="get">
            ...
            <div class="girl_list_column">
                ...
                <div class="girl_list_button_blue">
                    <a href="girl_edit/{{ $girl->id }}">編集</a>
                </div>
                <div class="girl_list_button_red">
